        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
              <img src="template/web/images/person_1.jpg" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="template/web/images/person_2.jpg" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
                <div class="category">Staff</div>
          ...
          <div class="col-md-4">
            <div class="post-entry">
              <img src="template/web/images/person_3.jpg" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
