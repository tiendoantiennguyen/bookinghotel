...
public class JPAConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://sql3.freemysqlhosting.net:3306/sql3475639");
		dataSource.setUsername("sql3475639");
		dataSource.setPassword("TvrRQlyLkb");
		
		
//		dataSource.setDriverClassName("com.mysql.jdbc.Driver");
//		dataSource.setUrl("jdbc:mysql://localhost:3306/nhapmoncongnghephanmem");
//		dataSource.setUsername("root");
//		dataSource.setPassword("tienNguye1n");
